 ...
 */
public class ZoomableDraweeView extends /*DraweeView<GenericDraweeHierarchy>*/ GenericDraweeView implements ScrollingView {
    ...
    /**
     * add by tuke
     * @param enabled true - default
     */
    public void setEnableSwipeDown(boolean enabled){
        mZoomableController.setEnableSwipeDown(enabled);
    }
