...
package com.yingke.frescoimagegallery.detail.zoomableview.zoomable;
...
import com.yingke.frescoimagegallery.detail.zoomableview.gestures.TransformGestureDetector;
...
public class DefaultZoomableController
    ...
    // add by tuke 下滑缩小是否可用
    private boolean mIsEnableSwipeDown = true;
    ...
    @Override
    public void setEnableSwipeDown(boolean enabled) {
        mIsEnableSwipeDown = enabled;
    }
...
//        }
  ...
  /* TransformGestureDetector.Listener methods  */
    ...
    public void onGestureUpdate(TransformGestureDetector detector) {
        ...
        if (mIsEnableSwipeDown && getScaleFactor() == getOriginScaleFactor() && !mCanScrollUpThisGesture && translateY > 0) {
